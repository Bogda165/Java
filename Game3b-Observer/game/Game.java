...
public class Game {
	...
	public static void main(String[] args) {
		...
		game.followClash(new ClashReport(game)); //2.0 another observer of the same kind
		game.followClash(new ClashKnights(game)); // myClass
		game.followClash(new ClashOgrs(game)); // myClass
